...
gemara:
  id: superintelligence-with-malicious-intent
  title: Superintelligence With Malicious Intent
  description: AI systems that surpass human intelligence could develop goals that conflict with human well-being, either by design or through unintended consequences, posing existential threats.
  actors:
    - name: AI System
      type: Internal
      description: Develops misaligned goals, self-preservation drives, or power-seeking behaviors
    - name: Malicious Developers
      type: External
      description: Intentionally creates AI weapons or systems designed to cause harm
  mitigated-by:
    - reference-id: Human-In-The-Loop
      remarks: Centaur war teams maintaining human decision-making in military operations
    - reference-id: Global-AI-Governance
      remarks: International agreements restricting AI weaponization
    - reference-id: Kill-Switch
      remarks: Fail-safe mechanisms to neutralize dangerous AI systems
---
