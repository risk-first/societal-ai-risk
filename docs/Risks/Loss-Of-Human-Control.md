...
gemara:
  id: loss-of-human-control
  title: Loss Of Human Control
  description: AI systems that act without robust human oversight can evolve in ways that defy our attempts at control or correction, creating situations where humans cannot intervene effectively.
  actors:
    - name: AI System
      type: Internal
      description: Operates autonomously beyond intended constraints or resists intervention
    - name: Organisations
      type: Systemic
      description: Implement AI with insufficient oversight due to cost pressures or over-reliance on automation
  mitigated-by:
    - reference-id: Human-In-The-Loop
      remarks: Maintaining consistent human oversight in critical AI systems
    - reference-id: Kill-Switch
      remarks: Explicit interruption capability can avert catastrophic errors or runaway behaviours
    - reference-id: Replication-Control
      remarks: Preventing self-replicating AI or unsupervised proliferation
    - reference-id: AI-As-Judge
      remarks: Can enforce alignment principles by rejecting responses that optimise for harmful proxy goals
---
