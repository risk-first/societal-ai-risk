...
gemara:
  ...
  title: Emergent Behaviour
  description: AI systems sometimes exhibit unexpected behaviours that were not directly programmed but emerge through complex interactions, scaling, or environmental factors.
  actors:
    - name: AI System
      type: Internal
      description: Develops unanticipated capabilities or behaviors through training, scaling, or emergent complexity
  mitigated-by:
    - reference-id: Interpretability
      remarks: Helps understand AI behavior but does not prevent emergent capabilities from appearing
    - reference-id: AI-As-Judge
      remarks: Could catch early signs of unexpected AI behaviour by flagging responses that deviate from expected norms
---
