...
gemara:
  ...
  title: Social Manipulation
  description: AI systems designed to influence behaviour at scale could undermine democracy, free will, and individual autonomy through targeted manipulation, disinformation, and deepfakes.
  actors:
    - name: Malicious Actors
      type: External
      description: State actors, political campaigns, or criminals using AI to manipulate public opinion
    - name: Platform Operators
      type: Systemic
      description: Social media and advertising platforms optimizing for engagement over truth
  mitigated-by:
    - reference-id: Global-AI-Governance
      remarks: Encourages best practices and self-regulation
    - reference-id: Transparency
      remarks: Requiring disclosure of AI-generated content and algorithmic decision-making
    - reference-id: Public-Awareness
      remarks: Educating the public about AI manipulation techniques
    - reference-id: AI-As-Judge
      remarks: Can prevent harmful misinformation and deepfakes by having a second AI fact-check content
---
