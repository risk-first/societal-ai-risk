...
gemara:
  ...
  title: Human In The Loop
  objective: Maintaining consistent human oversight in critical AI systems, ensuring that final decisions or interventions rest with human operators rather than the AI.
  mitigates:
    - reference-id: loss-of-human-control
      reason: Ensuring final decisions or interventions rest with human operators rather than the AI
    - reference-id: superintelligence-with-malicious-intent
      reason: Centaur war teams maintaining human decision-making in military operations
