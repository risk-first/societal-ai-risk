...
gemara:
  id: Transparency
  title: Transparency
  objective: Requiring AI developers to publish model architectures, data sources, and decision-making rationales, and mandating clear labeling of AI-generated content.
  mitigates:
    - reference-id: loss-of-diversity
      reason: Increases accountability but does not prevent monopolisation directly
    - reference-id: social-manipulation
      reason: Requiring disclosure of AI-generated content and algorithmic decision-making
---
